...
function AdoptPage() {
  ...
  return (
    <div className="mx-40 max-h-screen font-bold text-white">
      ...
      <div className="h-[50vh]  text-center flex bg-gray-800 rounded-t-3xl">
        ...
        <div className="w-2/4 bg-gray-800 p-2 rounded-t-3xl">
          ...
          <div className="flex text-3xl">
            ...
            <div className="ml-1">
              <p>
                {petDetails.gender.charAt(0).toUpperCase() +
                  petDetails.gender.slice(1).toLowerCase()}
              </p>
              <p>
                {petDetails.specie.charAt(0).toUpperCase() +
                  petDetails.specie.slice(1).toLowerCase()}
              </p>
              <p>
                {petDetails.breed.charAt(0).toUpperCase() +
                  petDetails.breed.slice(1).toLowerCase()}
              </p>
      ...
      <div className="flex  ">
        <div className="w-1/2 h-[30vh]  bg-gray-800 p-2 rounded-bl-3xl">
          {petDetails.desc}
        </div>
        <div className="w-1/2 h-[30vh]  bg-gray-800 text-center p-2  rounded-br-3xl">
          <button
            className="bg-gray-900 p-8 text-6xl  rounded-3xl"
            onClick={() => alert("Thank you for adopting me <3")}
          >
            Adopt
          </button>
        </div>
